...
export function OTPInput({
  ...
  const getInputClass = (i: number) =>
    cn(
      "w-12 h-12 text-center text-lg font-medium border border-gray-300 text-black dark:text-white bg-white dark:bg-black/10 dark:bg-white/10",
      i === 0 ? "rounded-l-md" : i === length - 1 ? "rounded-r-md" : "-ml-px",
      "focus:z-10 outline-none focus:ring-2 focus:ring-black/60 dark:focus:ring-white focus:border-black/60 dark:focus:border-white/60",
      inputClassName
    )
