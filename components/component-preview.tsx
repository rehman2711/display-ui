    ...
    if (!Component) {
      return (
        <p className="text-sm text-muted-foreground">
          Component{" "}
          <code className="relative rounded-lg bg-red-500 px-[0.3rem] py-[0.2rem] font-mono text-sm">
            {name}
          </code>{" "}
      ...
      <Tabs defaultValue="preview" className="relative mr-auto w-full">
        ...
        <TabsContent value="code">
          <div className="flex flex-col space-y-4">
            <div className="w-full rounded-lg [&_figure]:my-0 [&_pre]:max-h-[350px] [&_pre]:overflow-auto">
              {Code}
            </div>
          </div>
        </TabsContent>
